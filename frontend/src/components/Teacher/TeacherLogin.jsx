        ...
        <div className="min-h-screen bg-theme-bg flex items-center justify-center px-4">
            <div className="max-w-md w-full">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-theme-text">Teacher Portal</h1>
                    <p className="text-theme-text-secondary mt-2">Sign in to manage your classroom</p>
                </div>
                ...
                <div className="bg-surface rounded-theme-xl shadow-theme border border-theme-border p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 rounded-lg bg-surface-alt border border-theme-border text-theme-text focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
                                required
                            />
                        </div>
                        <div>
                    ...
                    <div className="mt-6 text-center space-y-2">
                        <p className="text-sm text-theme-text-muted">
                            ...
                            <Link to="/teacher/register" className="text-emerald-500 hover:underline font-medium">
                                Register here
                            </Link>
                        </p>
                        <p className="text-sm text-theme-text-muted">
