...
from .views import (
    ...
    RetentionCheckView, RecordHintUsageView, GenerateHintView,
    GenerateRecommendedInsightsView,
...
def auth_root(request):
    return JsonResponse({"message": "Auth API root is working. Please use specific endpoints like /api/login/"})
...
urlpatterns = [
    ...
    path('api/generate-hint/', GenerateHintView.as_view(), name='generate_hint'),
    path('api/recommended-insights/', GenerateRecommendedInsightsView.as_view(), name='recommended_insights'),
